...
namespace TechVeo.Authentication.Infra.Migrations
{
    ...
    [Migration("20260120014919_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechVeo.Authentication.Domain.Entities.ServiceClient", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Order Service",
                            Scopes = "orders.read,orders.write,users.read,products.read,categories.read"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Backoffice",
                            Scopes = "orders.read,orders.write,payments.read,payments.write,users.read,users.write,products.read,products.write,categories.read,categories.write,kitchen.read,kitchen.write"
                        });
                });

            modelBuilder.Entity("TechVeo.Authentication.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TechVeo.Authentication.Domain.Entities.User", b =>
                {
                    b.OwnsOne("TechVeo.Authentication.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    Address = "john.admin@techveo.com"
                                });
                        });

                    b.OwnsOne("TechVeo.Authentication.Domain.ValueObjects.Name", "Name", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
